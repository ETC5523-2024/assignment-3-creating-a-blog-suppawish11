...
NASA's significant budget investment, as shown in @fig-nasa-budget, has allowed for substantial long-term research and development efforts, averaging $20 billion annually over the last two decades. This consistent funding has fueled cumulative advancements in technology, improving NASA's mission capabilities and increasing the number of space objects launched into orbit. Moreover, developing cutting-edge technologies often necessitates extensive infrastructure, including specialized laboratories and equipment, which further supports the innovation and technology development efforts [@sadinNASATECHNOLOGYPUSH1989].

## Factors influencing the growth

The United States has experienced significant growth in the number of space objects launched into orbit, a direct result of advancements in space technology driven by contributions from various sectors such as the government, independent agencies, and private companies. Factors like the implementation of new national space policies and substantial investment funding from the US government have solidified the country's position as a leader in space exploration and technology [@sadinNASATECHNOLOGYPUSH1989]. This combination of efforts enables the US to maintain its competitiveness in satellite deployment and space research, furthering its role as an innovator in the rapidly evolving space industry.
